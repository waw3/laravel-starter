    ...
    public function dataTable($query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('show', function ($blog) {
                ...
                if (auth()->user()->can('backend.blogs.show', App\Models\Blog::class)) {
                    return '<a class="btn btn-danger btn-sm" href="'.url(route('backend.blogs.show', $blog->id)).'"><i class="fa fa-magnifying-glass"></i></a>';
                }
            ...
            ->addColumn('edit', function ($blog) {
                ...
                if (auth()->user()->can('backend.blogs.edit', App\Models\Blog::class)) {
                    return '<a class="btn btn-danger btn-sm" href="'.url(route('backend.blogs.edit', $blog->id)).'"><i class="fa fa-pencil"></i></a>';
                }
            ...
            ->addColumn('delete', function ($blog) {
                ...
                if (auth()->user()->can('backend.blogs.destroy', App\Models\Blog::class)) {
                    return '<form action="'.url(route('backend.blogs.destroy', $blog->id)).'" method="post" onsubmit="return confirm(\'are you sure you want to delete this blog?\')">
